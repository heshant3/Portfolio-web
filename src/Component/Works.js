...
export default function App() {
  ...
  return (
    <div className="worksmain">
      <Helmet>
        <meta name="description" content="Ui/Ux Engineer Works page" />
        <meta
          name="keywords"
      ...
      <div className="boxContent">
        <div className="item noisy">
          ...
          <p>
            Develop of wireless stethoscope with mobile AI assistant
            application.
          </p>
        ...
        <div className="item noisy">
          ...
          <p>
            Develop of website to provide bus schedules and reservation system.
          </p>
      ...
      <div className="botttxt">
        ...
        <div className="btfon">
          <IconContext.Provider value={{ className: "global-class-name" }}>
            ...
            <a onClick={handleClick} href="https://codepen.io/heshant3">
              {" "}
              <FaCodepen />{" "}
            </a>
            <a onClick={handleClick} href="https://dribbble.com/heshant3">
              {" "}
              <FaDribbbleSquare />{" "}
            </a>
